...
class RatingReviewController extends Controller
{
    ...
    public function viewDeliveryReviews($user_id)
    {
        ...
        $reviews = Rating::where('delivery_id', $user_id)->with('user', 'order.accept_delivery.user', 'restaurant')->orderBy('id', 'DESC')->get();
    ...
    public function viewStoreReviews($restaurant_id)
    {
        ...
        $reviews = Rating::where('restaurant_id', $restaurant_id)->with('user', 'order.accept_delivery.user')->orderBy('id', 'DESC')->get();
