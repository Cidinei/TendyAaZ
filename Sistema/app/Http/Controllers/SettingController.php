...
class SettingController extends Controller
{
    ...
    public function saveSettings(Request $request, Factory $cache)
    {
        ...
        'showCashChange', 'sortDeliveryStoresByDistance',
        'showCashChangeFoodomaPro', //foodmapro
        'enCODonSF']);
        // dd($allSettings);
        ...
        $checkboxesSettings = ['showPromoSlider', 'showMap', 'enablePushNotification', 'enablePushNotificationOrders', 'enableStoreWhatsappNotification', 'showGdpr', 'enableGoogleAnalytics', 'taxApplicable', 'enSOV', 'enSPU', 'enableFacebookLogin', 'enableGoogleLogin', 'enableDeliveryPin', 'hidePriceWhenZero', 'enableDeliveryGuyEarning', 'enPassResetEmail', 'showPercentageDiscount', 'showVegNonVegBadge', 'showFromNowDate', 'enDelChrRnd', 'expandAllItemMenu', 'smsRestaurantNotify', 'smsRestOrderValue', 'smsDeliveryNotify', 'smsOrderNotify', 'showOrderAddonsDelivery', 'showDeliveryFullAddressOnList', 'showUserInfoBeforePickup', 'recommendedLayoutV2', 'flatApartmentAddressRequired', 'showInActiveItemsToo', 'enGDMA', 'showPriceAndOrderCommentsDelivery', 'useSimpleSpinner', 'randomizeStores', 'showCouponDescriptionOnSuccess', 'stripeAcceptAliPay', 'stripeAcceptBitCoin', 'enIOSPWAPopup', 'mockSearchOnHomepage', 'stripeInlineCardCheckout', 'stripeAcceptIdealPayment', 'stripeAcceptFpxPayment', 'stripeCheckoutPostalCode', 'googleFullAddress', 'showDeliveryCollection', 'allowPaymentGatewaySelection', 'sortSelfpickupStoresByDistance', 'countQuantityAsTotalItemsOnCart', 'allowPaymentGatewaySelection', 'showTipsPercentage', 'showTipsAmount', 'showTryItOnPhone', 'showAddonPricesOnCart', 'showCustomerVatNumber', 'showPwaInstallPromptFooter',
         'showCashChange', 'sortDeliveryStoresByDistance',
         'showCashChangeFoodomaPro', //foodmapro
         'enCODonSF'];
        ...
        // $manifestFile = File::exists(base_path('manifest.json'));
        // if ($manifestFile) {
        //     $manifestFileContents = File::get(base_path('manifest.json'));
        //     $manifestFileContents = json_decode($manifestFileContents, true);
        //     $manifestFileContents['short_name'] = $request->storeName;
        //     $manifestFileContents['name'] = $request->storeName;
        //     $json_object = json_encode($manifestFileContents, JSON_UNESCAPED_SLASHES);
        //     File::put(base_path('manifest.json'), json_encode($json_object));
        // }
