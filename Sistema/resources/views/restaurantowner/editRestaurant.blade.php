                ...
                <div class="card-body">
                    <form action="{{ route('restaurant.updateRestaurant') }}" method="POST" enctype="multipart/form-data">
                        ...
                        @if(\Module::find("Cashback") && \Module::find("Cashback")->isEnabled())
                            @php $cashbacksetting = \Modules\Cashback\Entities\CashBackSetting::first();@endphp 
                            @if(!empty($cashbacksetting) && $cashbacksetting->restaurant_edit)
                                <div class="text-left">
                                    <div class="form-group row"> 
                                        ...
                                        <div class="col-lg-9">
                                            <div class="checkbox checkbox-switchery mt-2"> 
                                                <label> 
                                                    <input value="true" type="checkbox" class="switchery-primary" name="cashback_status" @if($restaurant->cashback_status) checked="checked" @endif> 
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <fieldset class="gllpLatlonPicker">
                            ...
                            <div class="d-flex justify-content-center">
                                <div class="col-lg-6 d-flex location-search-block">       
                                    <input type="text" class="form-control form-control-lg gllpSearchField" placeholder="{{__('storeDashboard.locationSearchPlaceholder')}}">
                                    <button type="button" class="btn btn-primary gllpSearchButton">{{__('storeDashboard.locationSearchBtnTxt')}}</button>
                                </div>
                            </div> 
                        </fieldset>
                        @else
                        ...
                        @endif
                        @if($restaurant->is_change_status)
                            ...
                            <div class="col-lg-8">
                                ...
                                @foreach($adminPaymentGateways as $adminPaymentGateway)
                                    <option value="{{ $adminPaymentGateway->id }}" class="text-capitalize" 
                                        ...
                                        <!-- Chang by FoodomaProPaymentOnDeliveryPro -->
                        ...
                        @if(\Nwidart\Modules\Facades\Module::find('OrderSchedule') && \Nwidart\Modules\Facades\Module::find('OrderSchedule')->isEnabled())
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">{{ __('orderScheduleLang.orderSchedulingOptionLabel') }}</label>
                                <div class="col-lg-9">
                                    <div class="checkbox checkbox-switchery mt-2">
                                        <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                            ...
                            @if($restaurant->is_schedulable && $restaurant->accept_scheduled_orders)
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">{{ __('orderScheduleLang.todayOrderScheduleAfterLabel') }}</label>
                                    <div class="col-lg-9">
                        ...
                        <div class="col-md-8">
                                <div class="card">
                                    <div class="card-body">
                                    <legend class="font-weight-semibold text-uppercase font-size-sm">
                                                        Notificação no WhatsApp para novo pedido (<b class="text-warning">CALLMEBOT</b>)
                                                    </legend>
                                                </div>
                                                <div class="form-group col"> 
                                                    <div class="form-group row"> 
                                                        <label class="col-lg-8 col-form-label"><strong> Chave de Api do WhatsApp: </strong></label>
                                                        <div class="col-lg-9">
                                                            <input type="text" class="form-control form-control-lg" name="storewhatsappApiKey"
                                                                value="{{ $restaurant->storewhatsappApiKey }}"
                                                                placeholder="Digite a chave api do Call Me bot">
                                                        </div>
                                                        </div>
                                                        <div class="form-group row">
                                                        <label class="col-lg-8 col-form-label"><strong> Número do WhatsApp: </strong></label>
                                                        <div class="col-lg-9">
                                                            <input type="text" class="form-control form-control-lg" name="storewhatsAppNumber"
                                                                value="{{ $restaurant->storewhatsAppNumber }}"
                                                                placeholder="Digite o número completo do WhatsApp">
                                                        </div>
                                                         </div>
                                                         <b><span class="mt-1"> </span>Para receber a chave Api do WhatsApp, siga este </span> <a href="https://manualdolojista.meuappon.com/utilidades/notificacoes-via-whatsapp" target="_blank"> MANUAL</a></b>
                                                </div> 
                                                </div>
