                    ...
                    @if (\Module::find("AddonsPro") && \Module::find("AddonsPro")->isEnabled()) 
                        <div id="_min_and_max" class="mt-4" style="display: none">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="number" class="form-control form-control-lg" name="minimum_qty" placeholder="" value="<?= $addonCategory->minimum_qty ?>"  min="1" max="999">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">Maximum Qty:</label>
                                <div class="col-lg-9">
                                    <input type="number" class="form-control form-control-lg" name="maximum_qty" placeholder="" value="<?=$addonCategory->maximum_qty?>" min="1" max="999">
                                </div>
                            </div>
                        </div>
