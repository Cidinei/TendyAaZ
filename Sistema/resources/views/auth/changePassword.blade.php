    ...
    <div class="card mb-0">
        <div class="card-body">
            <div class="text-center mb-3">
                ...
                <h5 class="mb-0">Criar Senha</h5>
            </div>

            <div class="form-group form-group-feedback form-group-feedback-left">
                <input type="text" class="form-control" placeholder="Digite o codigo para redefinir" name="code" required="required" value="{{ old('code') }}" autocomplete="new-code">
            ...
            <div class="form-group form-group-feedback form-group-feedback-left">
                <input type="password" class="form-control" placeholder="Nova Senha" name="password" required="required" value="{{ old('password') }}" autocomplete="new-password">
                <div class="form-control-feedback">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-block" style="height: 2.8rem; font-size: 1rem;">Redefinir Senha <i
