...
@section("title") Editar Idioma - Dashboard
@endsection
@section('content')
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4>
                <span class="font-weight-bold mr-2">Editando Idioma</span>
        ...
        <div class="card-body">
            <form action="{{ route('admin.updateTranslation') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <textarea class="summernote-editor" name="checkoutMessageOnIdle" placeholder="Checkout custom message on idle" rows="6">@if (!empty($data->checkoutMessageOnIdle)) {{ $data->checkoutMessageOnIdle }}@else{{ config('appSettings.checkoutMessageOnIdle') }}@endif</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Checkout custom message on checkout initiate process</strong></label>
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutMessageOnProcess" value="@if(!empty($data->checkoutMessageOnProcess)){{ $data->checkoutMessageOnProcess }}@else{{ config('appSettings.checkoutMessageOnProcess') }}@endif" placeholder="Checkout custom message on checkout initiate process">
                    </div>
                </div>
                ...
                @if (\Module::find("PaymentOnDeliveryPro") && \Module::find("PaymentOnDeliveryPro")->isEnabled()) 
                    ...
                    <button class="btn btn-primary translation-section-btn mt-4" type="button"> <i class="icon-mobile mr-1"></i>Payment on Delivery Pro   </button> 

                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>COD - Money</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="checkoutCodMoney"
                                value="@if(!empty($data->checkoutCodMoney)){{ $data->checkoutCodMoney}}@else{{ config('appSettings.checkoutCodMoney') }}@endif" placeholder="COD - Money">
                        </div>
                    </div>
                                        
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>COD - Credit Card</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="checkoutCodCreditcard"
                                value="@if(!empty($data->checkoutCodCreditcard)){{ $data->checkoutCodCreditcard}}@else{{ config('appSettings.checkoutCodCreditcard') }}@endif" placeholder="COD - Credit Card">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>COD - Debit Card</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="checkoutCodDebitcard"
                                value="@if(!empty($data->checkoutCodDebitcard)){{ $data->checkoutCodDebitcard}}@else{{ config('appSettings.checkoutCodDebitcard') }}@endif" placeholder="COD - Debit Card">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>COD - Food Voucher</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="checkoutCodFoodVoucher"
                                value="@if(!empty($data->checkoutCodFoodVoucher)){{ $data->checkoutCodFoodVoucher}}@else{{ config('appSettings.checkoutCodFoodVoucher') }}@endif" placeholder="COD - Food Voucher">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>COD - Meal ticket</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="checkoutCodMealIicket"
                                value="@if(!empty($data->checkoutCodMealIicket)){{ $data->checkoutCodMealIicket}}@else{{ config('appSettings.checkoutCodMealIicket') }}@endif" placeholder="COD - Meal ticket">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>COD - PicPay</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="checkoutCodPicPay"
                                value="@if(!empty($data->checkoutCodPicPay )){{ $data->checkoutCodPicPay }}@else{{ config('appSettings.checkoutCodPicPay') }}@endif" placeholder="COD - PicPay">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Change Money For</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="checkoutCodChangeMoneyFor"
                                value="@if(!empty($data->checkoutCodChangeMoneyFor)){{ $data->checkoutCodChangeMoneyFor}}@else{{ config('appSettings.checkoutCodChangeMoneyFor') }}@endif" placeholder="Change Money For">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Payment on Delivery Description</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="checkoutPaymentOnDeliveryDescription"
                                value="@if(!empty($data->checkoutPaymentOnDeliveryDescription)){{ $data->checkoutPaymentOnDeliveryDescription}}@else{{ config('appSettings.checkoutPaymentOnDeliveryDescription') }}@endif" placeholder="Payment on Delivery Description">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>COD - Confirm Button</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="checkoutCodConfirmButton"
                                value="@if(!empty($data->checkoutCodConfirmButton)){{ $data->checkoutCodConfirmButton }}@else{{ config('appSettings.checkoutCodConfirmButton') }}@endif" placeholder="COD - Confirm Button">
                        </div>
                    </div>             
                @endif 
                ...
                @if (\Module::find("AddonsPro") && \Module::find("AddonsPro")->isEnabled()) 
                    ...
                    <button class="btn btn-primary translation-section-btn mt-4" type="button"> <i class="icon-mobile mr-1"></i>Módulo de Complementos </button> 
                    
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Message Select the minimum quantity</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="addonsProSelectTheMinimumAmountOf"
                                value="@if(!empty($data->addonsProSelectTheMinimumAmountOf )){{ $data->addonsProSelectTheMinimumAmountOf }}@else{{ config('appSettings.addonsProSelectTheMinimumAmountOf') }}@endif" placeholder="Select the minimum amount of">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Message Select the maximum quantity</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="addonsProTheMaximumAmountIs"
                                value="@if(!empty($data->addonsProTheMaximumAmountIs  )){{ $data->addonsProTheMaximumAmountIs  }}@else{{ config('appSettings.addonsProTheMaximumAmountIs') }}@endif" placeholder="The maximum amount is">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Message in </strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="addonsProMessageIn"
                                value="@if(!empty($data->addonsProMessageIn )){{ $data->addonsProMessageIn }}@else{{ config('appSettings.addonsProMessageIn') }}@endif" placeholder="in">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Minimum </strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="addonsMinimumOf"
                                value="@if(!empty($data->addonsMinimumOf )){{ $data->addonsMinimumOf }}@else{{ config('appSettings.addonsMinimumOf') }}@endif" placeholder="Minimum">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Maximum  </strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="addonsMaximumOf"
                                value="@if(!empty($data->addonsMaximumOf )){{ $data->addonsMaximumOf }}@else{{ config('appSettings.addonsMaximumOf') }}@endif" placeholder="Maximum">
                        </div>
                    </div>
                @endif 
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryAppRequestedCashChangeMsg"
                            value="@if (!empty($data->deliveryAppRequestedCashChangeMsg)) {{ $data->deliveryAppRequestedCashChangeMsg }}@else{{ config('appSettings.deliveryAppRequestedCashChangeMsg') }}@endif" placeholder="Delivery Requested Cash Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryAppYouAreOnlineBtn"
                            value="@if (!empty($data->deliveryAppYouAreOnlineBtn)) {{ $data->deliveryAppYouAreOnlineBtn }}@else{{ config('appSettings.deliveryAppYouAreOnlineBtn') }}@endif" placeholder="Delivery You are Online Button Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryAppYouAreOfflineBtn"
                            value="@if (!empty($data->deliveryAppYouAreOfflineBtn)) {{ $data->deliveryAppYouAreOfflineBtn }}@else{{ config('appSettings.deliveryAppYouAreOfflineBtn') }}@endif" placeholder="Delivery You are Offline Button Text">
                    </div>
                </div>
                ...
                @if(\Nwidart\Modules\Facades\Module::find('OrderSchedule') && \Nwidart\Modules\Facades\Module::find('OrderSchedule')->isEnabled())
                    <button class="btn btn-primary translation-section-btn mt-4" type="button"> <i class="icon-calendar2 mr-1"></i>Order Schedule</button>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Schedule this order text</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="modOSScheduleThisOrderText" value="@if (!empty($data->modOSScheduleThisOrderText)) {{ $data->modOSScheduleThisOrderText }}@else{{ config('appSettings.modOSScheduleThisOrderText') }}@endif" placeholder="Schedule this order text">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Schedule for Text</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="modOSScheduleForText" value="@if (!empty($data->modOSScheduleForText)) {{ $data->modOSScheduleForText }}@else{{ config('appSettings.modOSScheduleForText') }}@endif" placeholder="Schedule for Text">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Select Date and Time Text</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="modOSSelectDateTimeText" value="@if (!empty($data->modOSSelectDateTimeText)) {{ $data->modOSSelectDateTimeText }}@else{{ config('appSettings.modOSSelectDateTimeText') }}@endif" placeholder="Select Date and Time Text">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Done Button Text</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="modOSDoneBtnText" value="@if (!empty($data->modOSDoneBtnText)) {{ $data->modOSDoneBtnText }}@else{{ config('appSettings.modOSDoneBtnText') }}@endif" placeholder="Done Button Text">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Remove Button Text</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="modOSRemoveBtnText" value="@if (!empty($data->modOSRemoveBtnText)) {{ $data->modOSRemoveBtnText }}@else{{ config('appSettings.modOSRemoveBtnText') }}@endif" placeholder="Remove Button Text">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="modOSSlotNotAvalText"
                                value="@if (!empty($data->modOSSlotNotAvalText)) {{ $data->modOSSlotNotAvalText }}@else{{ config('appSettings.modOSSlotNotAvalText') }}@endif" placeholder="No Slots Available Text">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Scheduled Order Status Text</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="scheduledOrderStatusText" value="@if (!empty($data->scheduledOrderStatusText)) {{ $data->scheduledOrderStatusText }}@else{{ config('appSettings.scheduledOrderStatusText') }}@endif" placeholder="Scheduled Order Status Text">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Confirmed Order Status Text</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="confirmedOrderStatusText" value="@if (!empty($data->confirmedOrderStatusText)) {{ $data->confirmedOrderStatusText }}@else{{ config('appSettings.confirmedOrderStatusText') }}@endif" placeholder="Confirmed Order Status Text">
                        </div>
                    </div>
                @endif
