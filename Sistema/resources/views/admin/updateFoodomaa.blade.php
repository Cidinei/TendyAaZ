...
@section("title") Atualizar - Dashboard
@endsection
@section('content')
    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-circle-right2 mr-2"></i>
                <span class="font-weight-bold mr-2">Atualizar Plataforma</span>
                @if($versionMsg != null)
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><span class="font-weight-bold">Nova versão instalada com sucesso ✅</span></h5>
            </div>
            <div class="modal-body">
                <span class="help-text">
                <br>
                Este processo geralmente leva
                <b> 40-60s </b>
                <br>Você será redirecionado automaticamente após a conclusão da atualização.
                </span>
                <div class="mt-4">
                ...
                <div id="updateMessage" class="hidden mt-0">
                    <br>
                    <span class="text-warning"><b>Não feche esta janela (ou clique no botão Voltar)</b></span>
                </div>
            </div>
        </div>
    </div>
