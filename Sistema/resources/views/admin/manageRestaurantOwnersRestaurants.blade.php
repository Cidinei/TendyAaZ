...
@section("title") Proprietários de Lojas - Dashboard
@endsection
@section('content')
<style>
    ...
    <div class="card">
        <div class="card-body">
            <legend class="font-weight-semibold text-uppercase font-size-sm">
                <i class="icon-address-book mr-2"></i> Lojas das contas de Proprietários
            </legend>
            <div class="form-group row form-group-feedback form-group-feedback-right">
                @if(count($userRestaurants) === 0)
                <div class="col-lg-9">
                    <p class="text-warning">{{ $user->name }} não é dono de nenhuma loja.</p>
                </div>
                @else
                <br>
                <div class="col-lg-9">
                    <p><strong>{{ $user->name }}</strong> é o dono de <strong>{{ $userRestaurants->count() }} </strong> Lojas.</p>
