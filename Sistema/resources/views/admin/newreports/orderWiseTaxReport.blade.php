...
@section("title") Impostos sobre pedidos - Relatório
@endsection
@section('content')
    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-circle-right2 mr-2"></i>
                <span class="font-weight-bold mr-2">Relatório de imposto sobre pedidos</span>
            ...
            <div class="card-body">
                ...
                <tfoot>
                    <tr>
                     ...
                     <th></th>
                     <th></th>
                     <th>{{ config('appSettings.currencyFormat') }} {{$totalOrder}}</th>
                     <th>{{ config('appSettings.currencyFormat') }} {{$taxTotal}}</th>
                 </tr>
             </tfoot>
         </table>
         <div class="mt-3">
