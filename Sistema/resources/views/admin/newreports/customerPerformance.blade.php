...
@section("title") Desempenho de Clientes - Relatórios @endsection
@section('content')
<style>
<style>
...
<div class="page-header">
  ...
  <div class="page-title d-flex">
    ...
    <span class="font-weight-bold mr-2">Relatório de desempenho do cliente</span>
  ...
  <div class="row mt-3">
    ...
    <div class="col-xl-12 dashboard-display p-3">
      ...
      <div class="block-content block-content-full clearfix">
        ...
        <div class="font-size-sm text-uppercase text-muted">Total de Clientes</div>
      </div>
      </a>
    </div>
    </div>
    ...
    <div class="col-xl-12 dashboard-display p-3">
      ...
      <div class="block-content block-content-full clearfix">
        ...
        <div class="font-size-sm text-uppercase text-muted">Total de Vendas<br><span style="font-size: 0.5rem; font-weight: 500;">(Menos Despesas e Gorjetas de Entrega)</span></div>
      </div>
      </a>
    </div>
    </div>
    ...
    <div class="table-responsive">
      <table class="table">
        <thead>
         ...
         <th>Total de gorjetas</th>
         <th>Valor total</th>
         <th>Média de conclusão</th>
         <th>Itens mais pedidos</th>
         <th>Loja mais comprada</th>
         <th>Ação sugerida</th>
       </thead>
       <tbody>
         @php
        ...
        <tr>
          ...
          @if ($averageDeliveryTime > 45 || $averageDeliveryTime == 45)
            <span class="badge badge-flat border-grey-800 text-default text-left" style="background-color: red; color: white;">
              {{ $averageDeliveryTime ? $averageDeliveryTime . ' minutos' : 'N/A' }}
            </span>
          ...
          <td>
            ...
            <center><a href="{{ route('admin.banUser', $user->id) }}" style="color: white; font-size:14px;"><i class="icon-blocked"></i> BANIMENTO</a></center><br><br><a href="tel:{{$user->email}}" style="color: white;"><i class="icon-envelope"></i> {{ $user->email }}<br><br><i class="icon-phone"></i><a href="tel:{{$user->phone}}" style="color: white;"> {{$user->phone}}</a>
            </span>
            ...
            <span class="badge badge-flat border-grey-800 text-default text-left" style="background: orange; color: white; border-radius: 0px !important;">
              <i class="icon-warning"></i> PRESTAR ATENÇÃO
            </span>
            ...
            <span class="badge badge-flat border-grey-800 text-default text-left" style="background: green; color: white; border-radius: 0px !important;">
              <i class="icon-price-tag"></i> OFERECER
            </span>
            @else
      ...
      <tfoot>
        <tr>
          ...
          <th>{{ config('appSettings.currencyFormat') }}{{ $grandTotalTipAmount }}</th>
          <th>{{ config('appSettings.currencyFormat') }}{{ $grandTotalOrdersAmount }}</th>
