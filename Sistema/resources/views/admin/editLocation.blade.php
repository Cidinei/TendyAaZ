...
@section("title") Editar local popular - Dashboard
@endsection
@section('content')
            ...
            <div class="card-body">
                <form action="{{ route('admin.updateLocation') }}" method="POST">
                    <legend class="font-weight-semibold text-uppercase font-size-sm">
                        <i class="icon-address-book mr-2"></i> Detalhes do local
                    </legend>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="name"
                                placeholder="Nome do local" required value="{{ $location->name }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="description"
                                placeholder="Descrição curta do local" value="{{ $location->description }}">
                        </div>
                    </div>
                    <div class="form-group row">
