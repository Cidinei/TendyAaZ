        ...
        <div class="card-body">
            <form action="{{ route('admin.saveNewTranslation') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <textarea class="summernote-editor" name="checkoutMessageOnIdle" placeholder="Checkout custom message on idle" rows="6">{{ config('appSettings.checkoutMessageOnIdle') }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Checkout custom message on checkout initiate process</strong></label>
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutMessageOnProcess" value="{{ config('appSettings.checkoutMessageOnProcess') }}" placeholder="Checkout custom message on checkout initiate process">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryAppRequestedCashChangeMsg"
                            value="{{ config('appSettings.deliveryAppRequestedCashChangeMsg') }}" placeholder="Delivery Requested Cash Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryAppYouAreOnlineBtn"
                            value="{{ config('appSettings.deliveryAppYouAreOnlineBtn') }}" placeholder="Delivery You are Online Button Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryAppYouAreOfflineBtn"
                            value="{{ config('appSettings.deliveryAppYouAreOfflineBtn') }}" placeholder="Delivery You are Offline Button Text">
                    </div>
                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="modOSScheduleThisOrderText"
                                value="{{ config('appSettings.modOSScheduleThisOrderText') }}" placeholder="Schedule this order text">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="modOSScheduleForText"
                                value="{{ config('appSettings.modOSScheduleForText') }}" placeholder="Schedule for Text">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="modOSSelectDateTimeText"
                                value="{{ config('appSettings.modOSSelectDateTimeText') }}" placeholder="Select Date and Time Text">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="modOSDoneBtnText"
                                value="{{ config('appSettings.modOSDoneBtnText') }}" placeholder="Done Button Text">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="modOSRemoveBtnText"
                                value="{{ config('appSettings.modOSRemoveBtnText') }}" placeholder="Remove Button Text">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="modOSSlotNotAvalText"
                                value="{{ config('appSettings.modOSSlotNotAvalText') }}" placeholder="No Slots Available Text">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="scheduledOrderStatusText"
                                value="{{ config('appSettings.scheduledOrderStatusText') }}" placeholder="Scheduled Order Status Text">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="confirmedOrderStatusText"
                                value="{{ config('appSettings.confirmedOrderStatusText') }}" placeholder="Confirmed Order Status Text">
                        </div>
                    </div>
                @endif
