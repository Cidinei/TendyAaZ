...
@section("title") Avaliações da Loja - Dashboard
@endsection
@section('content')
<style>
	.text-truncate {
...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4>
                <span class="font-weight-bold mr-2">Avaliações de <a class="ml-1" href="{{ route('admin.get.editRestaurant', $restaurant->id) }}">{{ $restaurant->name }}</a></span> <span class="ml-1 badge badge-flat text-white {{ ratingColorClass($averageRating) }}">{{ $averageRating }} <i class="icon-star-full2 text-white" style="font-size: 0.6rem;"></i></span>
            </h4>
            ...
            <div class="modal-body">
            	<form action="{{ route('admin.updateStoreReview') }}" method="POST">
            		...
            		<div class="form-group row">
            		    <label class="col-lg-3 col-form-label"><span class="text-danger">*</span>Classificação de Entrega:</label>
            		    <div class="col-lg-9">
            		...
            		<div class="form-group row">
                        <label class="col-lg-3 col-form-label">Avaliação da entrega:</label>
                        <div class="col-lg-9">
            		...
            		<div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <textarea class="form-control" name="review_store" placeholder="Avaliação da loja"
