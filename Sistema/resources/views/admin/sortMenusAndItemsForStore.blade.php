...
@section("title") Mover Lojas e Produtos - Dashboard
@endsection
@section('content')
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4>
                <span class="font-weight-bold mr-2">Classificando Menu e Itens para: <a href="{{ route('admin.get.editRestaurant', $restaurant->id) }}"><b>{{ $restaurant->name }}</b></a></span>
            </h4>
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title"><span class="font-weight-bold">Classificar categoria de menu</span></h5>
                ...
                <div class="tab-content" style="width: 100%; padding: 0 25px;">
                    ...
                    <div class="tab-pane fade show @if($loop->first) active @endif" id="{{ str_slug($key.'-'.$loop->iteration) }}">
                        <legend class="font-weight-semibold font-size-sm">
                            Classificar produtos em: <b>{{ $key }} menu</b>
                        </legend>
