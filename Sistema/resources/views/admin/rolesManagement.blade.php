...
@section("title") Gerenciar funções e Permissões - Dashboard
@endsection
@section('content')
<style>
...
<div class="d-flex justify-content-center my-5" id="noRoleFoundBlock">
    <div class="text-center">
        <h3>Nenhuma função personalizada criada!</h3>
    ...
    <div class="card">
        <div class="card-body">
            <legend class="font-weight-semibold text-uppercase font-size-sm">
                <i class="icon-collaboration mr-2"></i> Nova função
            </legend>

            <form action="{{ route('admin.createNewRoleWithPermissions') }}" method="POST" enctype="multipart/form-data">
                
                <div class="form-group row">
                    <label class="col-lg-2 col-form-label"><strong>Nome:</strong></label>
                    <div class="col-lg-10">
                        <input type="text" name="name" placeholder="Nome da função. Exemplo: Gerente" required="required" class="form-control">
                    </div>
                </div>
    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4>
                ...
                <span class="font-weight-bold mr-2">{{ count($roles) }} Função personalizada</span>
            </h4>
