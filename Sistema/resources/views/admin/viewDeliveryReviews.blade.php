...
@section("title") Avaliações de Entregadores - Dashboard
@endsection
@section('content')
<style>
	.text-truncate {
...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4>
                <span class="font-weight-bold mr-2">Avaliações de <a class="ml-1" href="{{ route('admin.get.editUser', $user->id) }}">{{ $user->name }}</a></span> <span class="ml-1 badge badge-flat text-white {{ ratingColorClass($averageRating) }}">{{ $averageRating }} <i class="icon-star-full2 text-white" style="font-size: 0.6rem;"></i></span>
            </h4>
        			...
        			<tbody>
        				...
        				<tr>
        					...
        					<td class="text-center">
        						...
        						<button class="btn btn-sm btn-primary reviewViewButton" data-toggle="modal" data-target="#viewReviewModal" data-reviewId="{{ $review->id }}" data-ratingDelivery="{{ $review->rating_delivery }}" data-ratingStore="{{ $review->rating_store }}" data-reviewDelivery="{{ $review->review_delivery }}" data-reviewStore="{{ $review->review_store }}"> Ver </button>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><span class="font-weight-bold">Detalhes da Avaliação</span></h5>
            ...
            <div class="modal-body">
            	<form action="{{ route('admin.updateStoreReview') }}" method="POST">
            		...
            		<div class="form-group row">
            		    <label class="col-lg-3 col-form-label"><span class="text-danger">*</span>Classificação do Entregador:</label>
            		    <div class="col-lg-9">
            		...
            		<div class="form-group row">
                        <label class="col-lg-3 col-form-label">Avaliação do Entregador:</label>
                        <div class="col-lg-9">
                            <textarea class="form-control" name="review_delivery" placeholder="Avaliação da entrega"
                                rows="6" id="deliveryReviewText"></textarea>
                        </div>
                    </div>

                    <div class="form-group row">
            		    <label class="col-lg-3 col-form-label"><span class="text-danger">*</span>Classificação da Loja:</label>
            		    <div class="col-lg-9">
            		...
            		<div class="form-group row">
                        <label class="col-lg-3 col-form-label">Avaliação da Loja:</label>
                        <div class="col-lg-9">
                            <textarea class="form-control" name="review_store" placeholder="Avalialão da loja"
