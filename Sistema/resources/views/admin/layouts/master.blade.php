...
<head>
    ...
    <link href="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/backend/css/bootstrap.min.css?v=2.9.1-BUILD-01"
        rel="stylesheet" type="text/css">
    ...
    <link href="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/backend/css/layout.min.css" rel="stylesheet"
        type="text/css">
    <link href="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/backend/css/components.min.css?v=2.9.1-BUILD-01"
        rel="stylesheet" type="text/css">
    ...
    <link href="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/backend/global_assets/css/extras/animate.min.css"
        rel="stylesheet" type="text/css">
    <link href="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/backend/css/backend-custom.css?v=2.9.1-BUILD-01"
        rel="stylesheet" type="text/css">
    <link type="text/css"
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key={{ config('appSettings.googleApiKeyNoRestriction') }}">
    </script>
    <script type="text/javascript"
