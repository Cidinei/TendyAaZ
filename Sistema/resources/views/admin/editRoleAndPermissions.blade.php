...
@section("title") Gerenciamento de funções e permissões - Dashboard
@endsection
@section('content')
<style>
...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4>
                <a href="{{ route('admin.rolesManagement') }}" class="btn btn-md btn-default mr-2" data-popup="tooltip" title="Voltar" data-placement="right"><i class="icon-circle-left2"></i></a>
            ...
            <div class="card-body">
                <form action="{{ route('admin.updateRoleAndPermissions') }}" method="POST" enctype="multipart/form-data">
                    <legend class="font-weight-semibold text-uppercase font-size-sm">
                        <i class="icon-collaboration mr-2"></i> Detalhes de funções
                    </legend>
                    <input type="hidden" name="id" value="{{ $role->id }}">

                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Nome da função:</label>
                        <div class="col-lg-9">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-9 col-form-label"><strong>Permissões:</strong></label>
                        <div class="text-right">
                            <button type="button" class="btn btn-primary btn-labeled btn-labeled-left btn-sm" id="checkAll" data-popup="tooltip" title="Duplo clique para marcar todas" data-placement="top">
                            <b><i class="icon-check ml-1"></i></b>
                                Marcar todas
                            </button>
                            <button type="button" class="btn btn-primary btn-labeled btn-labeled-left btn-sm" id="unCheckAll" data-popup="tooltip" title="Duplo clique para desmarcar todas" data-placement="top">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group form-group-feedback form-group-feedback-right search-box">
                                    <input type="text" class="form-control form-control-lg search-input"
                                        placeholder="Filtre por nome da permissão..." style="border: 1px solid #ccc; box-shadow: none; height: 2.5rem;">
...
<div class="content">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <legend class="font-weight-semibold text-uppercase font-size-sm">
                    <i class="icon-users2 mr-2"></i> Usuários com a função de <b>{{ $role->name }}</b>
                </legend>
...
<div class="content">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <p class="mb-0">Nenhum usuário encontrado com a função de <b>{{ $role->name }}</b></p>
            </div>
        </div>
    </div>
</div>
