...
@section("title")
Relatórios - Top Produtos | Dashboard 
@endsection
@section('content')
<style>
    .chart-container {
        ...
        <div class="col-xl-6">
            <div class="panel panel-flat dashboard-main-col mt-4" style="min-height: 30rem;">
                <div class="panel-heading">
                    <h4 class="panel-title pl-3 pt-3"><strong>Os 10 itens mais vendidos </strong></h4>
                    <hr>
                </div>
        ...
        <div class="col-xl-6 d-none d-md-block">
            <div class="panel panel-flat">
                <div class="panel-body">
                    ...
                    @else
                    <div class="chart-container has-scroll">
                        <h3 class="text-center"><i class="icon-exclamation"></i> Sem data</h3>
                    </div>
                    @endif
                </div>
            </div>
        ...
        require(
            ...
            function (ec, limitless) {
                ...
                basic_bar_options = {
                    ...
                    // Add title
                    title: {
                        text: 'Visão geral da maioria dos itens vendidos',
                        subtext: 'De todas os pedidos até {{ $todaysDate }}',
                        x: 'center'
                    },
