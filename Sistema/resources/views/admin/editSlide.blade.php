        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.updateSlide') }}" method="POST" id="slideForm" class="mt-3" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="uploader mt-1">
                                ...
                                <small>Dimensão para tela cheia 740x340px</small>
                            </div>
                        </div>
                    </div>
                    ...
                    @if($link != null)
                        <div class="my-4">
                         <p> <b> O slide está vinculado a </b> <br> {!! $link !!} <a href="javascript:void(0)" class="btn btn-outline-secondary btn-sm ml-2" id="changeLink">Alterar</a> </p> 
                       </div>
                    @else
                        <div class="my-4">
                            <p class="text-danger"> Este slide não está vinculado, por isso aparecerá no local selecionado de cada usuário.</p>
                        </div>
                    @endif
                    ...
                    <div class="form-group row hidden" id="customURL">
                       <label class="col-lg-3 col-form-label">URL Personalizado:</label>
                        <div class="col-lg-9">
                            ...
                            <span class="help-text small">Insira o URL completo com http: // ou https: // ou o redirecionamento não funcionará.</span>
                        </div>
                    </div>
                    ...
                    <div id="onCustomUrlActive" class="hidden">
                        ...
                        <div id="locationProperties" class="@if(!$slide->is_locationset) hidden @endif">
                            ...
                            <span class="text-muted">Você pode usar serviços como: <a href="https://www.mapcoordinates.net/pt" target="_blank">https://www.mapcoordinates.net/pt</a></span> <br> <span class="text-muted">Se você inserir uma Latitude/Longitude inválida, o app poderá travar com uma tela branca.</span>
                        </div>
                    </div>
                    @csrf
