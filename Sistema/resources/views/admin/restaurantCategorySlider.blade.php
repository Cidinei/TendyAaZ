...
@section("title") categorias de Lojas - Dashboard
@endsection
@section('content')
        ...
        <div class="card-body">
            <form action="{{ route('admin.saveRestaurantCategorySliderSettings') }}" method="POST">
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label">Ativar controle deslizante de categoria de loja: </label>
                    <div class="col-lg-9">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <select name="restaurantCategorySliderPosition" class="form-control form-control-lg" required="required">
                            <option @if(config('appSettings.restaurantCategorySliderPosition') == "0") selected="selected" @endif value="0">Antes da 1ª Loja</option>
                            <option @if(config('appSettings.restaurantCategorySliderPosition') == "1") selected="selected" @endif value="1">Após a 1ª Loja</option>
                            <option @if(config('appSettings.restaurantCategorySliderPosition') == "2") selected="selected" @endif value="2">Após a 2ª Loja</option>
                            <option @if(config('appSettings.restaurantCategorySliderPosition') == "3") selected="selected" @endif value="3">Após a 3ª Loja</option>
                            <option @if(config('appSettings.restaurantCategorySliderPosition') == "4") selected="selected" @endif value="4">Após a 4ª Loja</option>
                            <option @if(config('appSettings.restaurantCategorySliderPosition') == "5") selected="selected" @endif value="5">Após a 5ª Loja</option>
                            <option @if(config('appSettings.restaurantCategorySliderPosition') == "6") selected="selected" @endif value="6">Após a 6ª Loja</option>
                            <option @if(config('appSettings.restaurantCategorySliderPosition') == "7") selected="selected" @endif value="7">Após a 7ª Loja</option>
                            <option @if(config('appSettings.restaurantCategorySliderPosition') == "8") selected="selected" @endif value="8">Após a 8ª Loja</option>
                            <option @if(config('appSettings.restaurantCategorySliderPosition') == "9") selected="selected" @endif value="9">Após a 9ª Loja</option>
                            <option @if(config('appSettings.restaurantCategorySliderPosition') == "10") selected="selected" @endif value="10">Após a 10ª Loja</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <select name="restaurantCategorySliderSize" class="form-control form-control-lg">
                            <option @if(config('appSettings.restaurantCategorySliderSize') == "1") selected="selected" @endif value="1">Extra Pequeno</option>
                            <option @if(config('appSettings.restaurantCategorySliderSize') == "2") selected="selected" @endif value="2">Pequeno</option>
                            <option @if(config('appSettings.restaurantCategorySliderSize') == "3") selected="selected" @endif value="3">Médio</option>
                            <option @if(config('appSettings.restaurantCategorySliderSize') == "4") selected="selected" @endif value="4">Grande</option>
                            <option @if(config('appSettings.restaurantCategorySliderSize') == "5") selected="selected" @endif value="5">Extra Grande</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <select name="restaurantCategorySliderStyle" class="form-control form-control-lg">
                            <option @if(config('appSettings.restaurantCategorySliderStyle') == "1") selected="selected" @endif value="1">Quadrado</option>
                            <option @if(config('appSettings.restaurantCategorySliderStyle') == "0.4") selected="selected" @endif value="0.4">Padrão</option>
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label">Mostrar slide de categoria de loja: </label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
            ...
            <div class="row" id="sortable">
                ...
                <div class="col-md-2 mb-2 each-slide" data-id="{{ $slide->id }}">
                    ...
                    <div class="btn-group btn-group-justified" style="width: 150px">
                        ...
                        @if($slide->is_active)
                        <a href="{{ route('admin.disableRestaurantCategorySlide', $slide->id) }}" class="btn btn-secondary rounded-0" data-popup="tooltip" title="Desabilitar Slide" data-placement="bottom"> <i class="icon-switch2 ml-1"></i> </a>
                        @else
                        <a href="{{ route('admin.disableRestaurantCategorySlide', $slide->id) }}" class="btn btn-warning rounded-0" data-popup="tooltip" title="Habilitar Slide" data-placement="bottom"> <i class="icon-switch2 ml-1"></i> </a>
                        @endif
                    </div>
                </div>
                @endforeach
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="uploader">
                            ...
                            <span class="help-text text-muted">Dimensão mínima 384x384px</span>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label">Link para:</label>
                    <div class="col-lg-9">
...
<div id="manageRestaurantCategory" class="modal fade mt-5" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><span class="font-weight-bold">Gerenciar categoria</span></h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <div class="row">
...
<script>
    ...
    $(function () {
        ...
        $(".updateRestaurantCategory").submit(function(event) {
            ...
            .fail(function(data) {
                console.log("error");
                $.jGrowl("Algo deu errado, tente novamente.", {
                    position: 'bottom-center',
                    header: 'Wooopsss ⚠️',
                    theme: 'bg-warning',
                });
        ...
        $('#sortable').sortable({
            ...
            onUpdate: function (evt) {
              ...
              .done(function(res) {
                   $.jGrowl("Slides adicionado com sucesso", {
                       position: 'bottom-center',
                       header: 'Sucesso ✅',
                       theme: 'bg-success',
                       life: '2000',
