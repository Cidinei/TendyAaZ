...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4>
                <span class="font-weight-bold mr-2">Módulos Extras </span>
            </h4>
...
<div class="content">
  @if(!$checkZipExtension)
  <div class="col-md-12">
    <p class="text-danger font-weight-bold"><b>Extensão Zip PHP</b> não habilitada.
      <br>
      Portanto, você não poderá fazer upload de nenhum Módulo Premium.
      <br>
      <span class="font-weight-normal">Entre em contato com seu provedor de hospedagem para habilitar o <b>Zip PHP</b> para o seu servidor.</span>
    </p>
  </div>
  @else
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-justified align-items-center" @if(!$module->isEnabled()) style="flex-direction: row-reverse;" @endif>
                                        ...
                                        <a href="{{ route('admin.disableModule', $module->getStudlyName()) }}"
                                            class="btn btn-danger btn-labeled btn-labeled-left btn-sm enDisBtn ml-2" data-popup="tooltip" title="Duplo clique para desabilitar" data-placement="left">
                                        <b><i class="icon-cross2 ml-1"></i></b>
                                        Desabilitar
                                        </a>
                                        @else
                                        <a href="{{ route('admin.enableModule', $module->getStudlyName()) }}"
                                            class="btn btn-primary btn-labeled btn-labeled-left btn-sm enDisBtn"  data-popup="tooltip" title="Duplo clique para desabilitar" data-placement="left" style="max-width: 125px;">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="pc"
                                placeholder="Código" required id="pc">
                        </div>
                    </div>
