...
@section("title") Categoria de Produtos - Dashboard
@endsection
@section('content')
    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4>
                ...
                <span class="font-weight-bold mr-2">{{ $count }} Categoria de Menu</span>
            </h4>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#editItemCategory" data-catid="{{ $itemCategory->id }}" data-catname="{{ $itemCategory->name }}" class="btn btn-sm btn-primary editItemCategory"> Editar</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><span class="font-weight-bold">Nova categoria de produtos</span></h5>
...
<div id="editItemCategory" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><span class="font-weight-bold">Editar categoria de produtos</span></h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <form action="{{ route('admin.updateItemCategory') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="name"
                                placeholder="Nome da categoria de produtos" required id="itemCatName">
                        </div>
                    </div>
                    @csrf
                    <div class="text-right">
