...
@section("title") Configurações - Painel
@endsection
@section('content')
<style>
    .disable-switch {
...
<div class="content">
    <div class="col-md-12">
        <div class="card" style="min-height: 100vh;">
            <div class="card-body">
                <form action="{{ route('admin.saveSettings') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-lg-flex justify-content-lg-left">
                        ...
                        <div class="tab-content" style="width: 100%; padding: 0 25px;">
                            <div class="tab-pane fade show active" id="generalSettings">
                                <legend class="font-weight-semibold text-uppercase font-size-sm">
                                 ...
                                 {{-- <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>URL do site:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="storeUrl"
                                            value="{{ config('appSettings.storeUrl') }}"
                                            placeholder="Enter website URL like: https://seudominio.com" readonly="readonly">
                                    </div>
                                </div> --}}
                                    ...
                                    <div class="col-lg-9">
                                        <select name="timezone" class="form-control form-control-lg timezone-select select">
                                            <optgroup label="General">
                                                <option value="GMT">Fuso horário GMT</option>
                                                <option value="UTC">Fuso horário UTC</option>
                                            </optgroup>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Símbolo monetário:</strong></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Alinhamento do símbolo de moeda</strong></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Pagamento mínimo para loja
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Tempo máximo para aceitar o pedido:
                                    </strong></label>
                                    <div class="col-lg-9">
                                        ...
                                        <span class="help-text small">Tempo máximo em minutos após o qual o administrador recebe notificação na página de pedidos de que o dono da loja não aceitou o pedido.</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Tempo máximo para aceitação da entrega:
                                    </strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg threshold-time"
                                            name="deliveryAcceptTimeThreshold"
                                            value="{{ config('appSettings.deliveryAcceptTimeThreshold') }}">
                                        <span class="help-text small">Tempo máximo em minutos após o qual o administrador recebe notificação na página de pedidos de que o entregador não aceitou o pedido.</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Qualidade da imagem:</strong></label>
                                    <div class="col-lg-9">
                                        ...
                                        <span class="help-text small">Somente para upload de itens via admin e painel da loja.</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Permitir seleção de gateway de pagamento para proprietários de loja  <i class="icon-question3 ml-1" data-popup="tooltip" title="Habilitar isso permitirá que os proprietários da loja habilitem os gateways de pagamento de sua escolha na lista de gateways de pagamento ativos." data-placement="top"></i></strong> </label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Modo de Desenvolvedor
                                    </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                            ...
                            <div class="tab-pane fade" id="seoSettings">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Meta Título: </strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="seoMetaTitle"
                                            value="{{ config('appSettings.seoMetaTitle') }}" placeholder="Meta Título">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Meta Descrição: </strong></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Título do gráfico aberto: </strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="seoOgTitle"
                                            value="{{ config('appSettings.seoOgTitle') }}" placeholder="Título do gráfico aberto">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Descrição do gráfico aberto:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="seoOgDescription"
                                            value="{{ config('appSettings.seoOgDescription') }}"
                                            placeholder="Meta descrição do gráfico aberto">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 offset-lg-3">
                                        <img src="{{ substr(url('/'), 0, strrpos(url('/'), '/')) }}/assets/img/social/{{ config('appSettings.seoOgImage') }}"
                                            alt="Imagem do gráfico aberto" class="img-fluid mb-2" style="width: 30%;">
                                    </div>
                                    @endif
                                    <label class="col-lg-3 col-form-label"><strong>Imagem do gráfico aberto: </strong></label>
                                    <div class="col-lg-9">
                                        <input type="file" class="form-control-uniform" name="seoOgImage" data-fouc>
                                        <span class="help-text small">Dimensão da imagem 1200x630 </span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="seoTwitterTitle"
                                            ...
                                            placeholder="Descrição dos cartões do Twitter">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Descrição dos cartões do Twitter</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg"
                                ...
                                <div class="form-group row">
                                    ...
                                    @endif
                                    <label class="col-lg-3 col-form-label"><strong>Imagem dos cartões do Twitter:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="file" class="form-control-uniform" name="seoTwitterImage"
                                            data-fouc>
                                        <span class="help-text small">Dimensão da imagem 600x335</span>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="designSettings">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <span class="help-text small">Dimensão da imagem 320 x 108 - (somente imagem PNG)</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <span class="help-text small">Dimensão da imagem 512x512 (apenas imagem PNG)</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    @endif
                                    <label class="col-lg-3 col-form-label"><strong>Tela de abertura (Splash): </strong></label>
                                    <div class="col-lg-9">
                                        <input type="file" class="form-control-uniform" name="splashLogo" accept="image/jpeg" data-fouc>
                                        <span class="help-text small">Dimensão da imagem 480 x 853 (somente imagem JPG)</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    @endif
                                    <label class="col-lg-3 col-form-label"><strong>Tela boas vindas: </strong></label>
                                    <div class="col-lg-9">
                                        <input type="file" class="form-control-uniform" name="firstScreenHeroImage"
                                            data-fouc>
                                        <span class="help-text small">Dimensão da imagem 592x640 </span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Cor de fundo do carrinho:</strong></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Cor do texto do carrinho:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control colorpicker-show-input"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Destaque produto novo:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control colorpicker-show-input"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Destaque produto popular:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control colorpicker-show-input"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>destaque produto recomendado:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control colorpicker-show-input"
                            ...
                            <div class="tab-pane fade" id="pushNotificationSettings">
                                <legend class="font-weight-semibold text-uppercase font-size-sm">
                                    Notificação push de aplicativo de entrega / cliente (<b class="text-warning">Firebase</b>)
                                </legend>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Habilitar notificações push</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Notificações push para atualizações de pedidos</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>ID do remetente do Firebase:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="firebaseSenderId"
                                            value="{{ config('appSettings.firebaseSenderId') }}"
                                            placeholder="Insira o ID do remetente do Firebase">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Certificado Firebase Web Push:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="firebasePublic"
                                            value="{{ config('appSettings.firebasePublic') }}"
                                            placeholder="Insira a chave pública do Firebase (certificado)">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Chave do servidor Firebase:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="firebaseSecret"
                                            value="{{ config('appSettings.firebaseSecret') }}"
                                            placeholder="Digite o segredo do Firebase">
                                        <p class="text-default"><strong>Observação: </strong> Não cole uma chave de servidor herdada.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <br>
                                <span><strong class="text-danger">IMPORTANTE</strong> Para saber como assinantes, notificações push e alertas funcionam <a href="#" target="_blank"><b>Clique aqui</b> </a></span>
                                <hr>
                                <div class="mt-4"></div>
                                <legend class="font-weight-semibold text-uppercase font-size-sm">
                                    Notificação push do painel da loja (<b class="text-warning">OneSignal</b>)
                                </legend>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>ID do aplicativo OneSignal:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="oneSignalAppId"
                                            value="{{ config('appSettings.oneSignalAppId') }}"
                                            placeholder="Insira o ID do aplicativo OneSignal">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Chave de API OneSignal Rest:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="oneSignalRestApiKey"
                                            value="{{ config('appSettings.oneSignalRestApiKey') }}"
                                            placeholder="Chave de API OneSignal Rest">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Mensagem de notificação push de novo pedido:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="restaurantNewOrderNotificationMsg"
                                            ...
                                            placeholder="Mensagem de notificação push de novo pedido">
                                    </div>
                                </div>
                                <legend class="font-weight-semibold text-uppercase font-size-sm">
                                    Notificações no WhatsApp para novos pedidos (<b class="text-warning">CALLMEBOT</b>)
                                </legend>
                                
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Habilitar notificações no WhatsApp para Lojistas</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('appSettings.enableStoreWhatsappNotification')=="true" )
                                            checked="checked" @endif name="enableStoreWhatsappNotification">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Mensagem de novo pedido:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="whatsappStore"
                                            value="{{ config('appSettings.whatsappStore') }}"
                                            placeholder="Chegou um novo pedido!">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="socialLoginSettings">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Habilitar login do Facebook</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>ID do aplicativo do Facebook:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="facebookAppId"
                                            value="{{ config('appSettings.facebookAppId') }}"
                                            placeholder="Insira o ID do aplicativo do Facebook">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Texto do botão de login do Facebook:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg"
                                            name="facebookLoginButtonText"
                                            value="{{ config('appSettings.facebookLoginButtonText') }}"
                                            placeholder="Texto do botão de login do Facebook">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Habilitar login do Google</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>ID de aplicativo do Google:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="googleAppId"
                                            value="{{ config('appSettings.googleAppId') }}"
                                            placeholder="Insira o ID do Google App">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Texto do botão de login do Google:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg"
                                            name="googleLoginButtonText"
                                            value="{{ config('appSettings.googleLoginButtonText') }}"
                                            placeholder="Texto do botão de login do Google">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="mapSettings">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Chave de API do Google Map: </strong> <br>
                                    (com restrição de HTTP)</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="googleApiKey"
                                            value="{{ config('appSettings.googleApiKey') }}"
                                            placeholder="Chave de API do Google Map que possui restrições de HTTP">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Chave de API do Google Map:</strong> <br>
                                    (com restrição de IP)</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="googleApiKeyIP"
                                            value="{{ config('appSettings.googleApiKeyIP') }}"
                                            placeholder="Chave de API do Google Map que possui restrições de IP">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Chave de API do Google Map:</strong> <br>
                                                    (sem restrição de IP / HTTP)</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="googleApiKeyNoRestriction" placeholder="Chave de API do Google Map sem restrições de IP e HTTP"
                                            value="{{ config('appSettings.googleApiKeyNoRestriction') }}">
                                    </div>
                                </div>

                                <hr>
                                <a href="#" target="_blank" rel="nofollow">Clique aqui</a>
                                para saber como configurar chaves de API do Google.<br>
                            </div>
                            <div class="tab-pane fade" id="paymentGatewaySettings">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">
                                    <strong>Idioma Stripe:</strong>
                                    </label>
                                    <div class="col-lg-9">
                                        <select name="stripeLocale" class="form-control form-control-lg select">
                                        <option value="auto" @if(config('appSettings.stripeLocale')=="auto") selected @endif >Stripe detecta o idioma do navegador</option>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Mostrar entrada de código postal Stripe</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Ambiente Paypal:</strong></label>
                                    <div class="col-lg-9">
                                        ...
                                        selected @endif>Produção (Live)</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Chave do Sandbox do Paypal:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="paypalSandboxKey"
                                            value="{{ config('appSettings.paypalSandboxKey') }}"
                                            placeholder="Chave de cliente do Paypal Sandbox (deixe em branco se não estiver usando o PayPal)">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Chave de produção do Paypal:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg"
                                            name="paypalProductionKey"
                                            value="{{ config('appSettings.paypalProductionKey') }}"
                                            placeholder="Chave do cliente de produção do Paypal (deixe em branco se não estiver usando o PayPal)">
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Token de acesso ao MercadoPago:</strong></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                 ...
                                 <span class="text-muted">Como obter as chaves: <a href="https://khalti.com/join/merchant" target="_blank">https://khalti.com/join/merchant</a></span><br>
                            ...
                            <div class="tab-pane fade" id="smsGatewaySettings">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Gateway de SMS padrão</strong></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="msg91AuthKey"
                                            value="{{ config('appSettings.msg91AuthKey') }}" placeholder="Chave de autenticação MSG91">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="msg91SenderId"
                                            ...
                                            placeholder="ID do remetente MSG91">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>ID do modelo DLT para mensagem OTP: (apenas para a Índia)</strong></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>ID do modelo DLT para mensagem de novo pedido da loja: (apenas para a Índia)</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="msg91NewOrderDltTemplateId"
                                            ...
                                            placeholder="ID do modelo DLT para mensagem de novo pedido">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>ID do modelo DLT para mensagem de novo pedido do entregador: (apenas para a Índia)</strong></label>
                                    <div class="col-lg-9">
                                ...
                                <p class="text-danger"><b>MSG91</b> requer registro DLT de ID do remetente e todas as mensagens para enviar SMS para a Índia. Contate MSG91 para mais informações. Ou visite: <a href="https://help.msg91.com/article/348-dlt-registration">https://help.msg91.com/article/348-dlt-registration</a></p>
                                <hr>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label"><strong>Número de telefone Twilio:</strong></label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control form-control-lg" name="twilioFromPhone"
                                        value="{{ config('appSettings.twilioFromPhone') }}"
                                        placeholder="Número de telefone Twilio">
                                </div>
                            </div>
                            <hr>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Tipo de login / registro</strong></label>
                            <div class="col-lg-9">
                                <select name="enOLnR" class="form-control form-control-lg select">
                                    <option @if(config('appSettings.enOLnR') == "true") selected @endif value="true">Login OTP por telefone (recomendado)</option>
                                    <option @if(config('appSettings.enOLnR') == "false") selected @endif value="false">Login de e-mail / senha</option>
                                </select>
                            </div>
                        </div>

                        <div class="form-group row @if(config('appSettings.enOLnR') == "true") hidden @endif" id="enSOVBlock">
                            <label class="col-lg-3 col-form-label"><strong>Verificação de OTP no registro (para login por e-mail / senha)</strong></label>
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                    <input value="true" type="checkbox" class="switchery-primary"
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Mensagem OTP:</strong></label>
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="otpMessage"
                                    value="{{ config('appSettings.otpMessage') }}" placeholder="Mensagem OTP: ">
                            </div>
                        </div>
                        <hr>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Notificação por SMS para proprietários de lojas</strong></label>
                            <div class="checkbox checkbox-switchery mt-2">
                                <div class="col-lg-9">
                                    <label>
                                    <input value="true" type="checkbox" class="switchery-primary"
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Mensagem de novo pedido dos proprietários da loja:</strong></label>
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="defaultSmsRestaurantMsg"
                                    value="{{ config('appSettings.defaultSmsRestaurantMsg') }}" placeholder="Mensagem de novo pedido dos proprietários da loja">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <hr>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Notificação por SMS para entregadores</strong></label>
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                    <input value="true" type="checkbox" class="switchery-primary"
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Mensagem de novo pedido do entregador</strong></label>
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="defaultSmsDeliveryMsg"
                                    value="{{ config('appSettings.defaultSmsDeliveryMsg') }}" placeholder="Mensagem de novo pedido do entregador">
                            </div>
                        </div>
                        <hr>
                        {{-- 
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Notificação por SMS para o status do pedido</strong></label>
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                    <input value="true" type="checkbox" class="switchery-primary"
                    ...
                    <div class="tab-pane fade" id="emailSettings">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Gateway de e-mail padrão</strong></label>
                            <div class="col-lg-9">
                                ...
                                <option @if(config('appSettings.defaultEmailGateway') == "smtp" ) selected @endif value="smtp">SMTP personalizado</option>
                                </select>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Chave API SendGrid</strong></label>
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="sendgrid_api_key"
                                    value="{{ config('appSettings.sendgrid_api_key') }}" placeholder="Chave API SendGrid">
                            </div>
                        </div>
                    </div>
                    <div id="smtpSettings" class="@if (config('appSettings.defaultEmailGateway') != "smtp") hidden @endif">
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Host SMTP</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="mail_host"
                                value="{{ config('appSettings.mail_host') }}" placeholder="Host SMTP">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Porta SMTP</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="mail_port"
                                value="{{ config('appSettings.mail_port') }}" placeholder="Porta SMTP">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Nome de usuário SMTP</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="mail_username"
                                value="{{ config('appSettings.mail_username') }}" placeholder="Nome de usuário SMTP">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Senha SMTP</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="mail_password"
                                value="{{ config('appSettings.mail_password') }}" placeholder="Senha SMTP">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Criptografia SMTP</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="mail_encryption"
                                value="{{ config('appSettings.mail_encryption') }}" placeholder="Criptografia SMTP">
                        </div>
                    </div>
            </div>
            <hr>
            <div class="form-group row">
                <label class="col-lg-3 col-form-label"><strong>Enviar e-mails de "e-mail"</strong></label>
                <div class="col-lg-9">
                    <input type="email" class="form-control form-control-lg" name="sendEmailFromEmailAddress"
                        ...
                        placeholder="Digite um e-mail como do-not-reply@mywebsite.com">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-lg-3 col-form-label"><strong>Enviar e-mails de "Nome"</strong></label>
                <div class="col-lg-9">
                    <input type="text" class="form-control form-control-lg" name="sendEmailFromEmailName"
                        ...
                        placeholder="Digite o nome do endereço de e-mail (Ex: nome do seu site)">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-lg-3 col-form-label"><strong>E-mail de redefinição de senha "Assunto"</strong></label>
                <div class="col-lg-9">
                    <input type="text" class="form-control form-control-lg" name="passwordResetEmailSubject"
                        ...
                        placeholder="Digite o assunto do e-mail para recuperação de senha (Ex: redefinição de senha)">
                </div>
            </div>

            <div class="form-group row">
                <label class="col-lg-3 col-form-label"><strong>Habilitar e-mail de fatura do pedido</strong></label>
                <div class="col-lg-9">
                    <div class="checkbox checkbox-switchery mt-2">
                        <label>
                        <input value="true" type="checkbox" class="switchery-primary"
                        @if(config('appSettings.sendOrderInvoiceOverEmail')=="true" ) checked="checked"
            ...
            <div class="form-group row">
                <label class="col-lg-3 col-form-label"><strong>Assunto do e-mail da fatura do pedido</strong></label>
                <div class="col-lg-9">
                    <input type="text" class="form-control form-control-lg" name="orderInvoiceEmailSubject"
                        value="{{ config('appSettings.orderInvoiceEmailSubject') }}"
                        placeholder="Assunto do e-mail da fatura do pedido (# ID do pedido será automaticamente anexado no final)">
                </div>
            </div>

            <div>
                <p><strong class="text-danger">IMPORTANTE:</strong> Depois de salvar as configurações, envie um e-mail de teste para o seu endereço de e-mail antes de ativar a funcionalidade de redefinição de senha
                </p>
                <button
                    type="button" class="btn btn-primary btn-md" id="toggleSendTestEmail" autocomplete="false"> Enviar teste
                Email</button>
            ...
            <hr>
            <div class="form-group row">
                <label class="col-lg-3 col-form-label"><strong>Ativar e-mail de redefinição de senha?</strong></label>
                <div class="col-lg-9">
                    <div class="checkbox checkbox-switchery mt-2">
                        <label>
                        <input value="true" type="checkbox" class="switchery-primary"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title"><span class="font-weight-bold text-danger"> <i class="icon-exclamation mr-2"></i> Isenção de responsabilidade importante</span></h5>
                        </div>
                        <div class="modal-body">
                            <p>
                                Você selecionou para usar <strong>Gateway SMTP personalizado</strong>.
                                <br><br>
                                Somente SendGrid API Email Gateway é oficialmente compatível. 
                                <br><br>
                                Se você configurar um gateway SMTP personalizado, estará sozinho!
                                <br>
                                O envio de e-mails não pode ser garantido com as configurações do gateway SMTP personalizado, pois as configurações podem variar de servidor para servidor.
                                <br><br>
                                <strong>Quaisquer tíquetes de suporte relacionados a problemas de gateway SMTP personalizado serão<span class="text-danger">fechada</span> automaticamente.</strong>
                            </p>
                        </div>
            ...
            <script>
                ...
                $('#sendTestEmailNow').click(function(event) {
                    ...
                    if (testEmail.length) {
                        ...
                        .done(function(data) {
                            $.jGrowl("Por favor, verifique sua caixa de entrada.", {
                        ...
                        $.jGrowl("Por favor, insira um endereço de e-mail no formato correto.", {
                            position: 'bottom-center',
                            header: 'Wooopsss ⚠️',
                            theme: 'bg-warning',
                            life: '3500'
            ...
            <div class="tab-pane fade" id="taxSettings">
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Habilitar imposto:</strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Porcentagem de Imposto:</strong></label>
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="taxPercentage"
                            value="{{ config('appSettings.taxPercentage') }}"
                            placeholder="Porcentagem de Imposto">
                    </div>
                </div>
            </div>
            <div class="tab-pane fade" id="customerAppSettings">
                <legend class="font-weight-semibold text-uppercase font-size-sm">
                    Configurações do aplicativo do cliente
                </legend>
                
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Habilitar Dinheiro em Retirada no Balcão<span class="badge badge-flat border-grey-800 text-danger text-capitalize mx-1">NOVO</span> <i class="icon-question3 ml-1" data-popup="tooltip" title="O gateway de pagamento em dinheiro na entrega está desabilitado em pedidos de autopreenchimento por padrão. Ativar esta opção mostrará a opção de pagamento com pagamento na entrega também para pedidos de autopreenchimento." data-placement="top"></i></strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                            @if(config('appSettings.enCODonSF')=="true")
                            checked="checked" @endif name="enCODonSF">
                            </label>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Mostrar troco para pagamento em dinheiro
                    <span class="badge badge-flat border-grey-800 text-danger text-capitalize mx-1">NEW</span> <i class="icon-question3 ml-1" data-popup="tooltip" title="Se ativado, em pagamentos à vista, o cliente será solicitado a inserir o valor do troco de que precisa." data-placement="top"></i></strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <!-- FoodomaProPaymentOnDeliveryPro -->
                @if (\Module::find("PaymentOnDeliveryPro") && \Module::find("PaymentOnDeliveryPro")->isEnabled()) 
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Mostrar Troca de Dinheiro no COD
                        <span class="badge badge-flat border-grey-800 text-danger text-capitalize mx-1">NEW</span> <i class="icon-question3 ml-1" data-popup="tooltip" title="Se ativado, em pagamentos à vista, o cliente será solicitado a inserir o valor do troco de que precisa." data-placement="top"></i></strong></label>
                        <div class="col-lg-9">
                            <div class="checkbox checkbox-switchery mt-2">
                                <label>
                                <input value="true" type="checkbox" class="switchery-primary"
                                @if(config('appSettings.showCashChangeFoodomaPro')=="true" )
                                checked="checked" @endif name="showCashChangeFoodomaPro">
                                </label>
                            </div>
                        </div>
                    </div>                   
                @endif 
                <!-- endFoodomaProPaymentOnDeliveryPro -->

                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Classificar lojas de entrega por distância
                    <span class="badge badge-flat border-grey-800 text-danger text-capitalize mx-1">NOVO</span></strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Mostrar prompt de instalação do PWA
                    <i class="icon-question3 ml-1" data-popup="tooltip" title="sso mostrará o novo prompt de instalação do PWA acima do rodapé na página inicial." data-placement="top"></i></strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Mostrar número de imposto / IVA na página Minhas contas</strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Mostrar preços adicionais no carrinho
                    </strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Mostrar "Instalar no telefone" na tela inicial</strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Habilitar valor da gorjeta de entrega</strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <div class="form-group row">
                    <div class="col-md-3 col-lg-3 col-form-label">
                        <label><strong>Valor da gorjeta <i class="icon-question3 ml-1" data-popup="tooltip" title="Digite qualquer valor e pressione Enter no teclado" data-placement="top"> </i></strong></label>
                    </div>
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Ativar porcentagem de gorjeta de entrega</strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <div class="form-group row">
                    <div class="col-md-3 col-lg-3 col-form-label">
                        <label><strong>Porcentagem de gorjeta  <i class="icon-question3 ml-1" data-popup="tooltip" title="Digite qualquer valor percentual e pressione Enter no teclado" data-placement="top"> </i> </strong></label>
                    </div>
                    <div class="col-md-9 tipss">
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Mostrar quantidade total de itens no carrinho de rodapé <i class="icon-question3 ml-1" data-popup="tooltip" title="Se desativado, a contagem de itens exclusivos no carrinho será mostrada no rodapé" data-placement="top"></i>
                    </strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Endereço completo automático na seleção de local Page <i class="icon-question3 ml-1" data-popup="tooltip" title="A desativação só mostrará localidade, cidade, país e código PIN na caixa de endereço automático" data-placement="top"></i>
                    </strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Barra de pesquisa na página inicial <i class="icon-question3 ml-1" data-popup="tooltip" title="Isso substituirá a mensagem de sucesso do cupom padrão" data-placement="top"></i>
                    </strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Tipo de navegação do rodapé
                    </strong></label>
                    <div class="col-lg-9">
                        <select name="footerStyleType" class="form-control form-control-lg select">
                        <option value="FIXED"
                        @if(config('appSettings.footerStyleType')=="FIXED" )
                        selected="selected" @endif>Estilo Fixo
                        </option>
                        <option value="FLOAT"
                        @if(config('appSettings.footerStyleType')=="FLOAT"
                        ) selected="selected" @endif>Estilo Flutuante
                        </option>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Mostrar pop-up personalizado para adicionar à tela inicial do iOS  <i class="icon-question3 ml-1" data-popup="tooltip" title="Ativar isso exibirá um pop-up personalizado no dispositivo iOS para Adicionar à tela inicial uma vez por usuário, 3 segundos após o carregamento da página." data-placement="top"></i>
                    </strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Mostrar descrição do cupom<i class="icon-question3 ml-1" data-popup="tooltip" title="Isso substituirá a mensagem de sucesso do cupom padrão" data-placement="top"></i>
                    </strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Use Google Distance Matrix API  <i class="icon-question3 ml-1" data-popup="tooltip" title="As APIs do Google serão usadas para calcular a taxa de entrega se a loja tiver habilitado a taxa de entrega dinâmica" data-placement="top"></i>
                    </strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            ...
                            @endif name="enGDMA"> 
                            <b><span class="mt-1"><span class="text-danger"> IMPORTANTE: </span>Não habilite Google Distance Matrix API sem primeiro seguir </span> <a href="#" target="_blank"> esta documentação.</a><br>ocê verá uma tela de carregamento na página do carrinho se esta documentação não for seguida.</b>
                            </label>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Randomizar lojas
                    <i class="icon-question3 ml-1" data-popup="tooltip" title="As lojas de entrega e autopreenchimento serão aleatórias (a ordem de classificação será ignorada) - A posição das lojas ao pressionar o botão Voltar será alterada - Ativar NÃO é recomendado para uma melhor experiência do usuário" data-placement="right"></i>
                    </strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                ...
                <div class="form-group row">
                    ...
                    <i class="icon-question3 ml-1" data-popup="tooltip" title="Os itens inativos serão exibidos, mas o botão Adicionar ao carrinho não será mostrado" data-placement="left"></i>
                    </strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Referência Obrigatório no Endereço
                    </strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>PIN de entrega</strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Slider Promo </strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Emblema Veg / Não Veg
                    </strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Cobrança de entrega dinâmica
                    </strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Controle deslizante de item recomendado</strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Expandir o menu de todos os itens</strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Caixa de seleção GDPRx</strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Retirada no Balcão </strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Classificar lojas de auto-retirada por distância</strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Código de país padrão no telefone:</strong></label>
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="phoneCountryCode"
                            value="{{ config('appSettings.phoneCountryCode') }}"
                            placeholder="Campo de código de país padrão no telefone (deixe em branco se não for obrigatório)">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Mostrar porcentagem de desconto do produto</strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Use Simple Spinner para carregar páginas
                    </strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
            ...
            <div class="tab-pane fade" id="deliveryAppSettings">
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Habilitar ganhos do entregador </strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>O entregador está ganhando com</strong></label>
                    <div class="col-lg-9">
                        ...
                        ) selected="selected" @endif>Comissão do valor da taxa de entrega</option>
                        </select>
                    </div>
                </div>
                {{-- 
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Mostrar endereço completo na Lista de Pedidos</strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Mostrar complementos do pedido
                    </strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Mostrar preço, total e comentários do item</strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Mostrar coleção COD do entregador</strong></label>
                    <div class="col-lg-9">
                        <div class="checkbox checkbox-switchery mt-2">
                            <label>
                            <input value="true" type="checkbox" class="switchery-primary"
                ...
                <p><strong class="text-danger">Nota importante: </strong> ocê precisará sair do aplicativo de entrega e fazer login novamente para obter os congigs / configurações atualizados.</p>
                
                <!-- FoodomaProNotifyStoreAndDeliveryGuy -->
                @if (\Module::find("NotifyStoreAndDeliveryGuy") && \Module::find("NotifyStoreAndDeliveryGuy")->isEnabled()) 
                    <br><br>
                    <legend class="font-weight-semibold text-uppercase font-size-sm">
                    Configurações
                    </legend>
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>ID do APP OneSignal:
                        </strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="delivery_onesignal_app_id"
                                value="{{ config('appSettings.delivery_onesignal_app_id') }}"
                                placeholder="Aplicativo de entrega OneSignal APP ID">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>ID OneSignal Channell:</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="delivery_onesignal_channell_id"
                                value="{{ config('appSettings.delivery_onesignal_channell_id') }}"
                                placeholder="Aplicativo de entrega OneSignal Channel ID">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Chave de API OneSignal Rest:
                        </strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="delivery_onesignal_key_id"
                                value="{{ config('appSettings.delivery_onesignal_key_id') }}"
                                placeholder="Aplicativo de entrega de chave de API OneSignal Rest">
                        </div>
                    </div>                        
                @endif 
                <!-- endFoodomaProNotifyStoreAndDeliveryGuy -->

            </div>
            <div class="tab-pane fade" id="restaurantDashboardSettings">
                <legend class="font-weight-semibold text-uppercase font-size-sm">
                    Configurações do painel da loja
                </legend>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Taxa de busca de novo pedido:</strong></label>
                    <div class="col-lg-9">
                        <select name="restaurantNewOrderRefreshRate" class="form-control form-control-lg select">
                        <option value="5" @if(config('appSettings.restaurantNewOrderRefreshRate') == "5") selected @endif>Buscar a cada 5 segundos</option>
                        <option value="15" @if(config('appSettings.restaurantNewOrderRefreshRate') == "15") selected @endif>Buscar a cada 15 segundos</option>
                        <option value="25" @if(config('appSettings.restaurantNewOrderRefreshRate') == "25") selected @endif>Buscar a cada 25 segundos</option>
                        <option value="30" @if(config('appSettings.restaurantNewOrderRefreshRate') == "30") selected @endif>Buscar a cada 30 segundos</option>
                        </select>
                        <span class="help-text small mt-2"> Quanto menor o valor, mais carga no servidor. Recomendado é <strong>15 segundos </strong></span>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Tom de Notificação:</strong></label>
                    <div class="col-lg-9">
                ...
                @if (\Module::find("NotifyStoreAndDeliveryGuy") && \Module::find("NotifyStoreAndDeliveryGuy")->isEnabled()) 
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>ID do APP OneSignal:</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="store_onesignal_app_id"
                                value="{{ config('appSettings.store_onesignal_app_id') }}"
                                placeholder="Aplicativo da loja OneSignal APP ID">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>ID OneSignal Channell:</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="store_onesignal_channell_id"
                                value="{{ config('appSettings.store_onesignal_channell_id') }}"
                                placeholder="Aplicativo da loja OneSignal Channel ID">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Chave de API OneSignal Rest:</strong></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="store_onesignal_key_id"
                                value="{{ config('appSettings.store_onesignal_key_id') }}"
                                placeholder="OneSignal Key ID store aplication">
                        </div>
                    </div>                                        
                @endif 
                <!-- endFoodomaProNotifyStoreAndDeliveryGuy -->
            ...
            <div class="tab-pane fade" id="customCSS">
                ...
                <p>O código abaixo afetará o estilo do aplicativo do cliente e do aplicativo de entrega
                </p>
                <div id="css_editor1">{{ config('appSettings.customCSS') }}</div>
                <textarea style="display: none" class="form-control" name="customCSS" rows="5"
                    placeholder="Seu código CSS vai aqui ...">{{ config('appSettings.customCSS') }}</textarea>
            </div>
            <div class="tab-pane fade" id="cacheSettings">
                ...
                <div class="row">
                    <p class="col-md-3 col-xs-12"><strong>Versão do aplicativo: </strong></p>
                    <span class="col-md-6 col-xs-12">{{ $versionMsg }}</span>
                </div>
                <div class="row">
                    <p class="col-md-3 col-xs-12"><strong>Hash do cache: </strong></p>
                    <span
                        class="col-md-6 col-xs-12" id="cacheVersion">{{ implode('-', str_split($versionJson->forceCacheClearVersion, 5)) }}</span>
                </div>
                <div class="row">
                    <p class="col-md-3 col-xs-12"><strong>Hash de configurações: </strong></p>
                    <span
                        class="col-md-6 col-xs-12" id="settingsVersion">{{ implode('-', str_split($versionJson->forceNewSettingsVersion, 5)) }}</span>
                </div>
                {{-- 
                <div class="row">
                    <p class="col-md-3 col-xs-12"><strong>Sair Hash: </strong></p>
                    <span
                        class="col-md-6 col-xs-12" id="logoutVersion">{{ implode('-', str_split($versionJson->forceLogoutAllCustomers, 5)) }}</span>
                </div>
                --}}
                <hr>
                <h4 class="font-weight-bold">Forçar limpeza de cache</h4>
                <p>Isso forçará a limpeza do cache em seus dispositivos e atualizará o aplicativo no dispositivo do usuário.
                </p>
                <a href="javascript:void(0)" data-type="CACHE" data-popup="tooltip"
                    ...
                    class="icon-arrow-right7"></i></b> Forçar limpeza de cache</a>
                <hr>
                <h4 class="font-weight-bold">Forçar novas configurações</h4>
                <p>Isso forçará a atualização de novas configurações para todos os usuários e entregadores.</p>
                ...
                <b><i class="icon-arrow-right7"></i></b> Forçar novas configurações</a>
                <hr>
                {{-- 
                <h4 class="font-weight-bold">Forçar clientes sair </h4>
                <p>Isso fará o logout de todos os usuários do aplicativo (não para administradores e proprietários de lojas) <br>
                    <b class="text-danger">Prossiga com cuidado</b>
                </p>
                ...
                <b><i class="icon-arrow-right7"></i></b> Forçar o logout de clientes</a>
                <hr>
                --}}
                <p class="text-danger">
            ...
            <div class="tab-pane fade" id="fixUpdateIssues">
                <legend class="font-weight-semibold text-uppercase font-size-sm">
                    Corrigir problemas de atualização
                </legend>
                <p>Após uma atualização, o aplicativo frontal (para cliente ou entrega) terá alguns problemas.
                    <br> O problema pode ser devido a:
                </p>
                <ol>
                    <li> Erro de banco de dados devido ao URL incorreto</li>
                    <li> Erro de origem cruzada devido a URL não HTTPS</li>
                    <li> Problemas de cache</li>
                </ol>
                <p><strong>Clique no botão abaixo para corrigir esses problemas.</strong></p>
                <a href="{{ route('admin.fixUpdateIssues') }}" class="btn btn-lg btn-primary" id="fixUpdateIssuesButton">Corrija os problemas agora</a>
            </div>
            <div class="tab-pane fade" id="advanceSettings">
                ...
                <ul>
                    <li>Todos os usuários (incluindo proprietários de loja e pessoal de entrega), exceto o superadministrador</li>
                    <li>Todo o restaurantes</li>
                    <li>Todas as categorias de itens, itens, categorias de complementos, complementos</li>
                    <li>Todos os pedidos</li>
                    <li>Categorias da loja e controles deslizantes de categoria</li>
                    <li>Sliders promocionais e todos os slides</li>
                    <li>Todos os registros de transações de carteira e carteira</li>
                    <li>Todos os pagamentos da loja e registros de pagamentos da loja</li>
                    <li>Todas as coletas de entrega e registros de coleta de entrega</li>
                    <li>Todos os endereços dos usuários, Localizações GPS do entregador</li>
                    <li>Dados internos vinculados aos pedidos</li>
                </ul>
                <p><strong>O que não será removido?</strong></p>
                <ul>
                    <li>Configurações do site</li>
                    <li>Dados de traduções</li>
                    <li>Cupons</li>
                    <li>Páginas</li>
                    <li>Locais geográficos populares</li>
                </ul>
                <button type="button" class="btn btn-danger btn-labeled btn-labeled-left"  data-popup="tooltip" title="Ao clicar neste botão, você será solicitado a confirmar esta ação." data-placement="right">
                    <b><i class="icon-trash"></i></b>
                    <span data-toggle="modal" data-target="#cleanEverything">Zerar Sistema</span>
                </button>
                <hr class="mt-4">

                <div class="mt-4">
                    <p class="text-danger mb-2"><strong>RECURSO EXPERIMENTAL </strong> - BETA</p>
                    ...
                    <p class="mt-2"> Observe que o recurso de backup é experimental e o backup não funciona em todos os servidores (mesmo se uma mensagem de sucesso for retornada). Estaremos melhorando isso nas versões futuras, se possível, ou este módulo pode ser removido nas versões futuras.</p>
                </div>
                <hr class="mt-4">
                <div class="mt-4">
            ...
            <div id="cleanEverything" class="modal fade" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title"><span class="font-weight-bold text-danger"> <i class="icon-exclamation mr-2"></i> Esta é uma ação irreversível.</span></h5>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        <div class="modal-body">
                            <div class="form-group row">
                                <label class="col-lg-12 col-form-label">Digite <b>CONFIRM</b> para prosseguir.</label>
                                <div class="col-lg-12">
    ...
    $(function() {
       ...
       $(document).on('keypress', '.tipss .select2-search__field', function () {
        ...
        $('.payment-gateway-switch').click(function(event) {
            ...
            .done(function() {
                $.jGrowl("Gateway de pagamento atualizado", {
                    position: 'bottom-center',
                    header: 'SUCESSO 👌',
                    theme: 'bg-success',
                });
            ...
            .fail(function() {
                $.jGrowl("Algo deu errado! (Pelo menos um gateway precisa estar ativo)", {
                    position: 'bottom-center',
                    header: 'Wooopsss ⚠️',
                    theme: 'bg-warning',
                });
        ...
        $('#forceClearCache, #forceClearSettings').dblclick(function(event) {
            ...
            .fail(function(data) {
                ...
                $.jGrowl("Algo deu errado! Por favor, tente novamente mais tarde.", {
                    position: 'bottom-center',
                    header: 'Wooopsss ⚠️',
                    theme: 'bg-warning',
                });
