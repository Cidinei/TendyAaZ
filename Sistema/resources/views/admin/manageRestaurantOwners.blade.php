...
@section("title")
Proprietários de Lojas | Dashboard
@endsection
@section('content')

<div class="content mt-3">
    <div class="d-flex justify-content-between my-2">
        <h3><strong> <i class="icon-circle-right2 mr-2"></i> proprietários de Lojas</strong></h3>
        <div>
...
<script>
    $('body').tooltip({selector: '[data-popup="tooltip"]'});
     var datatable = $('#usersDatatable').DataTable({
        ...
        language: {
            search: '_INPUT_',
            searchPlaceholder: 'Pesquise com qualquer coisa...',
            lengthMenu: '_MENU_',
