...
<div class="content mt-3">
    <div class="d-flex justify-content-between my-2">
        <h3><strong>  <i class="icon-basket mr-1"></i> Gestão de Pedidos</strong></h3>
        <div>
            <button type="button" class="btn btn-secondary btn-labeled btn-labeled-left" id="clearFilterAndState"> <b><i class=" icon-reload-alt"></i></b> Resetar filtros</button>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
        ...
        $('body').tooltip({selector: '[data-popup="tooltip"]'});
         ...
         var datatable = $('#ordersDataTable').DataTable({
           ...
           buttons: {
                   ...
                   buttons: [
                       {extend: 'csv', filename: 'orders-'+ new Date().toISOString().slice(0,10), text: 'Exportar para CSV'},
                   ]
               }
        });
